...
const sidebar = (props) => {
  ...
  return (
    ...
    <div className="flex flex-wrap justify-between p-2">
      <button className="m-1 px-2 py-1 bg-red-500 text-white rounded" onClick={props.clear}>
        Clear
      </button>
      <button className="m-1 px-2 py-1 bg-green-500 text-white rounded" onClick={props.sample}>
        Sample
      </button>
    </div>
    <PersonalDetails
